...
// 🎵 Background Music
const backgroundMusic = new Audio('./sounds/ninja.mp3');
...
// Play music on first key press (to bypass browser autoplay restrictions)
  ...
  if (!player.dead) {
    switch (event.key) {
      ...
      case 'a':
        ...
        break
      case 'w':
        if (!playerjumpCooldown) { 
          player.velocity.y = -20
          playerjumpCooldown = true;
          setTimeout(() => {
            playerjumpCooldown = false;
          }, jumpCooldownTime);
        }
        break
      case ' ':
